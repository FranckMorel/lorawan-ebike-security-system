...
#define MBED_CONF_LORA_APPLICATION_KEY                                        { 0x93, 0x10, 0xFA, 0x17, 0xA6, 0x0B, 0xCD, 0xE2, 0xDF, 0xF5, 0xB3, 0xCA, 0x63, 0xE2, 0x9F, 0x72 } // set by application[*]
...
#define MBED_CONF_LORA_DEVICE_EUI                                             { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x07, 0x35, 0xF7 }                                                 // set by application[*]
...
#define MBED_CONF_RTOS_MAIN_THREAD_STACK_SIZE                                 8192                                                                                               // set by application[DISCO_L072CZ_LRWAN1]
...
#define MBED_CONF_LORA_RANDOM_DEV_NONCE                                       1                                                                                                  // defined by application
#define MBED_CONF_PLATFORM_STDIO_CONVERT_NEWLINES                             1                                                                                                  // defined by application
#define MBED_CONF_PLATFORM_STDIO_MINIMAL_CONSOLE_ONLY                         0                                                                                                  // defined by application
